			...
			<div>
				{ this.props.loggedIn ? (
						...
						<div>
							...
							{this.props.user.user_type === 'client' && (<NavItem className={this.props.activePage[1] ? 'lighter': ''} onClick={this.toSearchBid}>View Bids</NavItem>)}
							...
							{this.props.user.user_type === 'client' && (<NavItem className={this.props.activePage[3] ? 'lighter': ''} onClick={this.toDoneClient}>Complete</NavItem>)}
							...
							{this.props.user.user_type === 'worker' && (<NavItem className={this.props.activePage[9] ? 'lighter': ''} onClick={this.toDoneWorker}>Complete</NavItem>)}
